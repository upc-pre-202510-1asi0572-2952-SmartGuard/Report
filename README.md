...
<table border="1" style="width: 100%; border-collapse: collapse;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>La app debe mostrar video en vivo de la cámara frontal de la cerradura.</li>
            <li>El streaming debe activarse con la detección de movimiento o bajo demanda.</li>
          </ul>
        </td>
        <td>EP02 - Comunicación Remota</td>
      </tr>
      ...
      <tr>
        ...
        <td>Como propietario, quiero ver imágenes o clips cortos de las visitas anteriores para tener evidencia en caso de incidentes.</td>
        <td>
          <ul>
            <li>El sistema debe almacenar imágenes o videos cortos por evento.</li>
